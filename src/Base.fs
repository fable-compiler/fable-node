...
// TODO: Use System.Exception instead?
...
type [<AllowNullLiteral>] Global =
    ...
    // abstract ('FIn->'FOut): obj with get, set
    ...
    // abstract Promise: ('FIn->'FOut) with get, set
    ...
    // abstract Symbol: ('FIn->'FOut) with get, set
    ...
    // abstract byte[]: obj with get, set
    // abstract Uint8ClampedArray: ('FIn->'FOut) with get, set

...
type IExports =
    ...
    abstract pbkdf2: password: string * salt: string * iterations: float * keylen: float * callback: (Error -> Buffer -> obj) -> unit
    abstract pbkdf2: password: string * salt: string * iterations: float * keylen: float * digest: string * callback: (Error -> Buffer -> obj) -> unit
